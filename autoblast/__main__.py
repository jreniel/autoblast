...
@click.option('--bin', type=click.Path(exists=True, dir_okay=False, path_type=Path), default='blastn')
...
def main(file_path, max_seqs_per_file, bin, db, max_target_seqs, outfmt):
    """
